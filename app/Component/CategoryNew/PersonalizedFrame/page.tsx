...
import { photoFrame,photoFrame2, type Product } from '@/lib/data/products';
...
export default function CardsPage() {
  ...
  const gotoParticularProduct = (product: Product) => {
    ...
    const gotoParticularProduct5 = (product: Product) => {
    const query = new URLSearchParams({
      id: product.id,
      image: product.image,
      image2: product.image2,
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight">
                Frame Your Memories
                <span className="block text-gray-700">In Style</span>
              </h1>

              <p className="text-lg text-gray-600 leading-relaxed">
                Transform your cherished moments into timeless art with custom photo frames. Personalized designs, premium quality, and ready to adorn your walls.
              </p>
            ...
            <p className="text-sm font-medium text-gray-700">Photo Quality</p>
          </div> */}
                <div className="text-center">
                  <div className="bg-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-2 shadow-md">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium text-gray-700">Cherished Gift</p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Our Photo Frame Collection</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Transform cherished memories into beautiful wall art with custom photo frames
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
           ...
           {/* Products Grid2 */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {photoFrame2.map((product) => (
              <div
                key={product.id}
                onClick={() => gotoParticularProduct5(product)}
                className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 cursor-pointer group"
              >
                {/* Image Container */}
                <div className="relative h-80 overflow-hidden bg-gray-100">
