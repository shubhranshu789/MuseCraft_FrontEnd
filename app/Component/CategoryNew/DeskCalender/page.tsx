...
import { deskCalender, type Product } from '@/lib/data/products';
import { Heart, Send, Sparkles, Calendar, Star } from 'lucide-react';
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight">
                Every Day Matters
                <span className="block text-gray-700">With Your Desk Calendar</span>
              </h1>

              <p className="text-lg text-gray-600 leading-relaxed">
                Stay organized and inspired all year with personalized desk calendars featuring your special dates, memories, and custom designs.
              </p>
              ...
              <div className="grid grid-cols-3 gap-4 pt-8">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium text-gray-700">Custom Dates</p>
                </div>
                <div className="text-center">
                  <div className="bg-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-2 shadow-md">
            ...
            <div className="relative h-[400px] md:h-[500px] rounded-3xl overflow-hidden shadow-2xl">
              <Image
                src="/LogoPics/Calender.jpg"
                alt="Personalized Desk Calendar"
                fill
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Our Calendar Collection</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Stay organized all year with personalized desk calendars featuring your special dates
            </p>
          </div>
