...
import { Heart, Send, Sparkles, BookOpen, Award } from 'lucide-react';
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight">
                Your Story Deserves
                <span className="block text-gray-700">A Magazine Edition</span>
              </h1>

              <p className="text-lg text-gray-600 leading-relaxed">
                Transform your memories, achievements, and special moments into a stunning
                personalized magazine. Premium quality printing meets your unique story.
              </p>
              ...
              <div className="grid grid-cols-3 gap-4 pt-8">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium text-gray-700">Premium Print</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative h-[400px] md:h-[500px] rounded-3xl overflow-hidden shadow-2xl">
              <Image
                src="/LogoPics/Magzine.jpg"
                alt="Personalized Magazine Cover"
                fill
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Create your personalized magazine with premium designs, custom layouts, and professional printing quality
            </p>
          </div>
