...
import { Caricurate, type Product } from '@/lib/data/products';
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Our Caricature Collection</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Transform your photos into fun, personalized caricature art that brings smiles to every occasion
            </p>
          </div>

          {/* Products Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {Caricurate.map((product) => (
              <div
                key={product.id}
