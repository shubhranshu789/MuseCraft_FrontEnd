              ...
              <div className="mb-6">
                ...
                <div className="space-y-3">
                  ...
                  <label className="flex items-center gap-3 p-4 border-2 rounded-lg cursor-pointer hover:border-blue-500 transition-colors">
                    ...
                    />
                    <div className="flex-1">
                      <span className="font-medium">80 Pages</span>
                      <span className="ml-2 text-gray-600">- ₹{basePrice + 600}</span>
                      <span className="ml-2 text-sm text-green-600">(+₹600)</span>
                    </div>
                  </label>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                 ...
                 <button
                    ...
                    disabled={loading}
                    className={`font-semibold py-4 px-6 rounded-xl border-2 transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed ${
                      isInCart
                  ...
                  >
                    <ShoppingCart 
                      className={`w-5 h-5 transition-colors duration-300 ${
                        isInCart ? 'fill-green-600 text-green-600' : ''
                      }`} 
                    />
